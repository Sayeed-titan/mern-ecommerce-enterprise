...
const OrderSuccess = () => {
  ...
  const downloadInvoice = () => {
    window.open(`${process.env.REACT_APP_API_URL}/orders/${orderId}/invoice`, '_blank');
  };
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <Link
          to="/orders"
          className="flex-1 text-center bg-gray-200 text-gray-700 py-3 rounded-lg hover:bg-gray-300 font-semibold"
        >
          View All Orders
        </Link>
        ...
        <Link
          to="/products"
          className="flex-1 text-center border-2 border-blue-600 text-blue-600 py-3 rounded-lg hover:bg-blue-50 font-semibold"
        >
          Continue Shopping
        </Link>
      </div>
